...
const About = () => {
  return (
    <>
      ...
      >
        I'm a pretty skilled software developer 
        with experience in React, Angular, Node.js, TypeScript and Three.js.
        ...
        Hope to work together soon to bring new ideas to life!
      </motion.p>
